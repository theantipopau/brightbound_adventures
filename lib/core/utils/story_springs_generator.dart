    ...
    final questionTypes = [
      ...
      () {
        final stories = [
          {
            'start':
                'Once upon a time, there was a little cat. The cat was very...',
    ...
    final questionTypes = [
      ...
      () {
        final scenarios = [
          {
            'question':
                'Sarah always helps her friends with homework. What character trait does Sarah show?',
            'options': ['Helpful', 'Selfish', 'Lazy', 'Mean'],
            'correct': 0,
          },
          {
            'question':
                'Tom practices soccer every day, even when it\'s hard. What trait does Tom show?',
            'options': ['Determined', 'Careless', 'Afraid', 'Bored'],
            'correct': 0,
          },
          {
            'question':
                'Emma shares her snacks with everyone. What trait does Emma show?',
      ...
      () {
        final elements = [
          {
            'question':
                'In the story "The Three Little Pigs," what is the main problem?',
            'options': [
              'The wolf wants to blow down the houses',
              'The pigs are hungry',
              'The pigs can\'t count',
    ...
    final questionTypes = [
      ...
      () {
        final themes = [
          {
            'story':
                'A girl works hard all summer to save money. She finally buys the bike she wanted.',
          ...
          {
            'story':
                'Two friends argue but then apologize and make up. They realize friendship is more important.',
      ...
      () {
        final pov = [
          {
            'question':
                '"I walked to the store and bought milk." What point of view is this?',
            'options': [
              'First person (I/me)',
              'Second person (you)',
              'Third person (he/she)',
          ...
          {
            'question':
                '"She opened the door carefully." What point of view is this?',
            'options': [
              'Third person (he/she)',
              'First person (I/me)',
              'Second person (you)',
      ...
      () {
        final prompts = [
          {
            'question':
                'You\'re writing a mystery story. What should happen to keep readers interested?',
            'options': [
              'Add clues slowly',
              'Tell everything at start',
              'Make it confusing',
              'Have no ending'
            ],
            'correct': 0,
          ...
          {
            'question':
                'Your character faces a big challenge. What makes a good solution?',
            'options': [
              'The character uses their skills',
              'Magic fixes everything instantly',
