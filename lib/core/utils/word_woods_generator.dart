...
class WordWoodsQuestionGenerator {
    ...
    if (questions.length < count) {
      ...
      for (int i = 0; i < remaining; i++) {
        ...
        if (_random.nextDouble() < 0.7 &&
            LiteracyWordBank.storyThemes.isNotEmpty) {
  ...
  static LiteracyQuestion? _fromNAPLAN(
  ...
  static LiteracyQuestion _generateProceduralThemeQuestion(
    ...
    if (difficulty <= 2 || (difficulty == 3 && _random.nextBool())) {
      ...
      if (r == 0) {
        typeTarget = 'noun';
        typeName = 'Naming Word (Noun)';
        correctList = nouns;
        distractors = [...verbs, ...adjs];
      } else if (r == 1) {
        typeTarget = 'verb';
        typeName = 'Action Word (Verb)';
        correctList = verbs;
        distractors = [...nouns, ...adjs];
      } else {
        typeTarget = 'adj';
        typeName = 'Describing Word (Adjective)';
        correctList = adjs;
        distractors = [...nouns, ...verbs];
      }
