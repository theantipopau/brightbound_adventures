...
class IsometricEngine {
  ...
  IsometricPosition screenToGrid(Offset screenPos) {
    ...
    final gridX = (relativeX / (tileWidth / 2) + relativeY / (tileHeight / 2)) / 2;
    final gridY = (relativeY / (tileHeight / 2) - relativeX / (tileWidth / 2)) / 2;
  ...
  List<T> sortByDepth<T>(List<T> objects, IsometricPosition Function(T) getPosition) {
...
class IsometricPathfinder {
  ...
  List<IsometricPosition>? findPath(IsometricPosition start, IsometricPosition goal) {
