...
class SilentLettersQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get hardQuestions => [
        ...
        LiteracyQuestion(
          ...
          skillId: 'silent_letters',
          question:
              'The word "knot" means a tight loop. What letter at the beginning is silent?',
          options: ['k', 'n', 'o', 't'],
          correctIndex: 0,
        ...
        LiteracyQuestion(
          ...
          skillId: 'silent_letters',
          question:
              '"Knight" and "night" sound the same. What makes "knight" different?',
          options: [
            'Different spelling',
            'It has a silent k',
          ...
          explanation:
              '"Knight" has a silent k and means a warrior. "Night" is darkness.',
          difficulty: 5,
        ),
      ];
}
...
class HomophonesQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          correctIndex: 0,
          hint:
              '"To" means direction. "Too" means also. "Two" is the number 2.',
        ...
        LiteracyQuestion(
          ...
          explanation:
              'The insect is spelled "bee". We spell the verb as "be".',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'homo_sea_1',
        ...
        LiteracyQuestion(
          ...
          correctIndex: 1,
          hint:
              '"There" shows a place. "Their" shows possession. "They\'re" = they are.',
        ...
        LiteracyQuestion(
          ...
          explanation:
              'The number is spelled "one". The past tense of win is "won".',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'homo_meet_1',
          ...
          explanation:
              '"Meet" means to come together. "Meat" is food from an animal.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'homo_knight_1',
          ...
          explanation:
              'A warrior is spelled "knight". The dark time is "night".',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'homo_write_1',
          ...
          correctIndex: 0,
          hint:
              '"Right" can mean correct or a direction. "Write" means to put words on paper.',
        ...
        LiteracyQuestion(
          ...
          explanation:
              '"Know" means to understand. "No" is the opposite of yes.',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          correctIndex: 0,
          hint:
              '"Their" shows who owns it. "There" is a place. "They\'re" = they are.',
        ...
        LiteracyQuestion(
          ...
          explanation:
              '"Its" shows possession: "its tail". "It\'s" means "it is".',
          difficulty: 3,
        ),
        LiteracyQuestion(
          id: 'homo_pair_1',
          ...
          explanation:
              '"Break" (to damage) and "brake" (to stop) sound the same.',
          difficulty: 3,
        ),
        LiteracyQuestion(
          id: 'homo_new_1',
        ...
        LiteracyQuestion(
          ...
          skillId: 'homophones',
          question:
              'The baker used ___ to make bread. Which spelling is correct?',
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"They\'re going their way over there" uses all three correctly.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'homo_context_1',
          skillId: 'homophones',
          question:
              'The baker used flour from the store. Which word is a homophone?',
        ...
        LiteracyQuestion(
          ...
          skillId: 'homophones',
          question:
              'The students practiced their spelling every knight. What\'s wrong?',
          options: [
          ...
          explanation:
              'The sentence should say "every night", not "every knight".',
          difficulty: 5,
        ),
        LiteracyQuestion(
          ...
          explanation:
              '"I know no one is here" uses both correctly. "Know" (understand) and "no" (not yes).',
          difficulty: 5,
        ),
      ];
}
...
class ApostrophesQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"Don\'t" is short for "do not". The apostrophe replaces the "o".',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'apos_cant_1',
        ...
        LiteracyQuestion(
          ...
          explanation:
              '"Its" shows possession: "the dog\'s tail". "It\'s" = it is.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'apos_is_1',
        ...
        LiteracyQuestion(
          ...
          explanation:
              '"Won\'t" is short for "will not", but the spelling changes.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'apos_shouldnt_1',
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        ...
        LiteracyQuestion(
          ...
          skillId: 'apostrophes',
          question:
              'The dogs\' toys are in the box. What does the apostrophe show?',
          options: [
            'Many dogs own toys',
            'One dog\'s toy',
            'The toys are small',
          ...
          correctIndex: 0,
          hint:
              'When multiple dogs own something, the apostrophe goes after the "s".',
        ...
        LiteracyQuestion(
          ...
          hint: '"It\'s" = "it is".',
          explanation:
              'Both "It\'s a wonderful day" and "It is a wonderful day" are correct.',
          difficulty: 3,
        ),
        LiteracyQuestion(
          id: 'apos_hasnt_1',
        ...
        LiteracyQuestion(
          ...
          options: [
            'Yes, for names ending in "s"',
            'No, it should be James\'s',
            'Both are acceptable',
            'Neither is correct'
          ],
          correctIndex: 2,
          ...
          explanation:
              'For names ending in "s", both "James\'" and "James\'s" are acceptable.',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          correctIndex: 3,
          hint:
              '"Children" is already plural, so the apostrophe goes before the "s".',
          explanation:
              '"The children\'s books" is correct. "Children" is plural, so we add \'s.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          ...
          skillId: 'apostrophes',
          question:
              'How many contractions are in this sentence? "I\'ve said they\'re good, and we\'ve seen it\'s true."',
          options: ['1', '2', '3', '4'],
          correctIndex: 3,
          hint: 'Count each word with an apostrophe that combines two words.',
          explanation:
              'There are 4 contractions: I\'ve, they\'re, we\'ve, it\'s.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'apos_error_1',
          skillId: 'apostrophes',
          question:
              'What\'s wrong with this sentence? "The birds nests were in the trees."',
          options: [
          ...
          explanation:
              'Should be "The birds\' nests" (nests belonging to multiple birds).',
          difficulty: 5,
        ),
      ];
}
...
class VocabularyInContextQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          question:
              'The puppy was very friendly and loved to play with everyone. What does "friendly" mean?',
          options: [
            'cold and mean',
            'nice and kind',
            'quick and fast',
          ...
          explanation:
              '"Friendly" means nice and kind to others. The puppy loved to play.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'vocab_context_2',
          skillId: 'vocabulary_in_context',
          question:
              'The huge elephant was enormous and so big it could barely fit in the truck. What does "enormous" mean?',
          options: ['very small', 'very big', 'very hungry', 'very tired'],
          correctIndex: 1,
          hint: 'The sentence tells us how big the elephant is.',
          explanation:
              '"Enormous" means very big. The elephant was so big it barely fit.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'vocab_context_3',
          skillId: 'vocabulary_in_context',
          question:
              'After running in the hot sun, Maya was exhausted and needed to rest. What does "exhausted" mean?',
          options: ['happy', 'very tired', 'confused', 'excited'],
          correctIndex: 1,
          hint: 'She ran in the hot sun and needed to rest.',
          explanation:
              '"Exhausted" means very tired. Maya needed rest after running.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'vocab_context_4',
          skillId: 'vocabulary_in_context',
          question:
              'The children looked gloomy and sad when they couldn\'t go to the park. What does "gloomy" mean?',
          options: ['happy', 'confused', 'sad and dark', 'excited'],
          correctIndex: 2,
          hint: 'The sentence says they looked sad.',
          explanation:
              '"Gloomy" means sad and dark. They couldn\'t go to the park.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'vocab_context_5',
          skillId: 'vocabulary_in_context',
          question:
              'The ancient temple was very old and had been standing for thousands of years. What does "ancient" mean?',
          options: ['brand new', 'very old', 'very small', 'very tall'],
          correctIndex: 1,
          hint: 'It has been standing for thousands of years.',
          explanation:
              '"Ancient" means very old. The temple was thousands of years old.',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'vocabulary_in_context',
          question:
              'The teacher\'s instructions were explicit and very clear about what we needed to do. What does "explicit" mean?',
          options: [
            'confusing',
          ...
          explanation:
              '"Explicit" means very clear and direct. We knew exactly what to do.',
          difficulty: 3,
        ),
        LiteracyQuestion(
          id: 'vocab_context_7',
          skillId: 'vocabulary_in_context',
          question:
              'Sarah felt anxious and worried about her test tomorrow. What does "anxious" mean?',
          options: ['angry', 'peaceful', 'worried and nervous', 'confused'],
          correctIndex: 2,
          hint: 'She is worried about her test.',
          explanation:
              '"Anxious" means worried and nervous. Sarah was concerned about her test.',
          difficulty: 3,
        ),
        LiteracyQuestion(
          id: 'vocab_context_8',
          skillId: 'vocabulary_in_context',
          question:
              'The meal was delicious and tasted absolutely wonderful. What does "delicious" mean?',
          options: ['not good', 'very tasty', 'cold', 'expensive'],
          correctIndex: 1,
          hint: 'It tasted absolutely wonderful.',
          explanation:
              '"Delicious" means very tasty. The meal tasted wonderful.',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'vocabulary_in_context',
          question:
              'The candidate was belligerent and argumentative, constantly disagreeing with everyone. What does "belligerent" mean?',
          options: ['friendly', 'shy', 'aggressive and hostile', 'intelligent'],
          correctIndex: 2,
          hint: 'The candidate constantly disagreed with everyone.',
          explanation:
              '"Belligerent" means aggressive and hostile. They disagreed constantly.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'vocab_context_10',
          skillId: 'vocabulary_in_context',
          question:
              'The plan was too ambitious and unrealistic for our small team to accomplish. What does "ambitious" mean?',
          options: [
            'easy',
            'difficult',
            'having high goals or expectations',
            'boring'
          ],
          correctIndex: 2,
          hint: 'The plan was too big for the small team.',
          explanation:
              '"Ambitious" means having high goals. This plan was too challenging.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'vocab_context_11',
          skillId: 'vocabulary_in_context',
          question:
              'Read: "The scientist\'s findings were inconclusive — she could not prove her hypothesis either way." What does "inconclusive" mean?',
          options: [
            'completely wrong',
            'very exciting',
          ...
          explanation:
              '"Inconclusive" means the evidence does not lead to a definite conclusion.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'vocab_context_12',
          skillId: 'vocabulary_in_context',
          question:
              'The word "notorious" is used in: "The notorious bushranger was feared across the colony." What does "notorious" mean?',
          options: [
          ...
          explanation:
              '"Notorious" means widely known for negative reasons. Being feared = bad reputation.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'vocab_context_13',
          skillId: 'vocabulary_in_context',
          question:
              'Two headlines: (A) "Politician makes bold claim" and (B) "Politician makes reckless claim." Both use a synonym for taking risk. What is the key difference in connotation?',
          options: [
          ...
          explanation:
              'Both involve risk, but "bold" has a positive connotation (brave), while "reckless" is negative (irresponsible). Word choice shapes how we judge the politician.',
          difficulty: 5,
        ),
      ];
}
...
class CommaUsageQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        ...
        LiteracyQuestion(
          ...
          explanation:
              'Use a comma between city and country: Sydney, Australia.',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'comma_intro_1',
          ...
          explanation:
              'Use a comma after "After school": After school, I went to the park.',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              'After a colon in a list, use commas: pizza, tacos, and pasta.',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          correctIndex: 0,
          hint:
              'Commas go around extra information in the middle of a sentence.',
          explanation:
              'Use commas around extra information: Sarah, who plays tennis, likes to run.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'comma_hard_2',
          skillId: 'comma_usage',
          question:
              'Which sentence correctly distinguishes a defining clause from a non-defining clause?',
          options: [
          ...
          correctIndex: 1,
          hint:
              'No commas = the clause defines WHICH one. Commas = extra information.',
          explanation:
              'Without commas, "who studied hardest" tells us WHICH student. With commas, it adds extra info (implying all students passed).',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'comma_hard_3',
          skillId: 'comma_usage',
          question:
              'Choose the sentence where the comma changes the meaning: "Let\'s eat Grandma" vs "Let\'s eat, Grandma." What does the comma do?',
          options: [
          ...
          explanation:
              'Without the comma, Grandma becomes the meal! The comma signals a direct address — we are talking TO Grandma, not about eating her.',
          difficulty: 5,
        ),
      ];
}
...
class VerbTenseQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"Runs" and "buys" are both present tense. Tenses match!',
          difficulty: 1,
        ),
        LiteracyQuestion(
          id: 'verb_tense_2',
          ...
          explanation:
              '"Played" is correct with "yesterday". "Play" is wrong for past time.',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'verb_tense',
          question:
              'Fix the tense error: "We went to the park and play games."',
          options: [
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"Had studied" and "passed" both show completed past actions.',
          difficulty: 5,
        ),
      ];
}
...
class PronounReferenceQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        ...
        LiteracyQuestion(
          ...
          explanation:
              'Sarah and Tom are two people, so use "they": "They are very good".',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"Dogs" is plural, so use "they": "The dogs ran and they were happy".',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'pronoun_reference',
          question:
              'What pronoun error is in: "Each student brought their book"?',
          options: [
          ...
          explanation:
              '"Each" is singular, so technically should be "his or her book" (though "their" is becoming accepted).',
          difficulty: 5,
        ),
      ];
}
...
class MainIdeaQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'main_idea',
          question:
              'Read: "Butterflies are insects. They have wings. They drink nectar from flowers." What is the main idea?',
          options: [
          ...
          explanation:
              'The passage describes what butterflies are and what they do.',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'main_idea',
          question:
              'What is the main idea? "Australia is home to unique animals found nowhere else in the world. Kangaroos hop across the outback. Koalas live in eucalyptus trees. Platypuses are one of the only egg-laying mammals."',
          options: [
          ...
          explanation:
              'The passage explains that Australia has unique animals not found elsewhere.',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'main_idea',
          question:
              'What is the main idea of a passage about how plants need sunlight, water, and soil to grow?',
          options: [
          ...
          explanation:
              'The main idea is that plants need multiple conditions to grow.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'main_idea_4',
          skillId: 'main_idea',
          question:
              'A passage states: "The Great Barrier Reef covers 344,000 km². It hosts 1,500 fish species, 4,000 types of mollusc, and 240 bird species. However, rising sea temperatures now threaten its survival." What is the main idea?',
          options: [
          ...
          correctIndex: 1,
          hint:
              'The passage describes the reef\'s size and biodiversity, then introduces a threat.',
          explanation:
              'The passage establishes the reef\'s importance (size + diversity) then introduces the key issue — climate threat. The main idea combines both.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'main_idea_5',
          skillId: 'main_idea',
          question:
              'Two paragraphs: Paragraph 1 lists the benefits of exercise (health, mood, energy). Paragraph 2 lists barriers (cost, time, tiredness). What is the overall main idea of BOTH paragraphs together?',
          options: [
          ...
          explanation:
              'A main idea for a multi-paragraph text must reflect the whole text — here, the benefits AND the barriers together.',
          difficulty: 5,
        ),
      ];
}
...
class InferenceQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get easyQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'inference',
          question:
              'Read: "Sarah brought an umbrella to school. When she looked outside, the sky was dark and grey." Why did Sarah bring the umbrella?',
          options: [
          ...
          explanation:
              'We can infer Sarah brought an umbrella because she expected rain (dark, grey sky).',
          difficulty: 1,
        ),
      ];
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'inference',
          question:
              'Read: "Tom studied for three hours. He organised his notes and made flashcards." What can we infer?',
          options: [
          ...
          explanation:
              'Tom\'s careful studying suggests he\'s preparing seriously, probably for a test.',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        LiteracyQuestion(
          ...
          skillId: 'inference',
          question:
              'From a passage where a character locks their bedroom door, hides a diary, and whispers to a friend, what can we infer?',
          options: [
          ...
          explanation:
              'These actions suggest the character values privacy and wants to keep something private.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'inference_4',
          skillId: 'inference',
          question:
              'Read: "Ms Chen marked the papers in red, handed them back without a word, and sat down facing the window." What can we best infer about Ms Chen\'s mood?',
          options: [
          ...
          correctIndex: 1,
          hint:
              'Consider what red marking, silence, and turning away from the class suggest together.',
          explanation:
              'Heavy red marking + silence + turning away are clues of disappointment. If she were happy, she would likely speak to the class.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'inference_5',
          skillId: 'inference',
          question:
              'A news article describes rising housing costs but never mentions the word "unfair". A reader infers the author thinks the situation is unjust. Which clue in an article would BEST support this inference?',
          options: [
          ...
          correctIndex: 2,
          hint:
              'Word choice reveals an author\'s viewpoint even without stating it directly.',
          explanation:
              'Quoting struggling families and using emotive words like "crisis" and "desperate" strongly implies the author views the situation as unjust, even without saying so.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'inference_6',
          skillId: 'inference',
          question:
              'Read: "Jaxon\'s hands were shaking. He read the letter three times. Then he very slowly folded it and placed it on the table." What emotion is Jaxon most likely experiencing?',
          options: [
            'Boredom',
            'Anger',
          ...
          correctIndex: 2,
          hint:
              'Think about why someone reads something multiple times and moves very slowly.',
          explanation:
              'Shaking hands, re-reading, and deliberate slow movement suggest Jaxon is in shock — processing something unexpected. He\'s not angrily crumpling it, just carefully folding it.',
          difficulty: 5,
        ),
      ];
}
...
class SentenceFormationQuestions extends SkillQuestionBank {
  ...
  List<LiteracyQuestion> get mediumQuestions => [
        LiteracyQuestion(
          ...
          explanation:
              '"She went" is correct past tense: "She went to the store yesterday".',
          difficulty: 3,
        ),
      ];
  ...
  List<LiteracyQuestion> get hardQuestions => [
        ...
        LiteracyQuestion(
          ...
          correctIndex: 0,
          hint:
              'A non-defining relative clause (extra information) needs commas on both sides.',
          explanation:
              '"Which I borrowed from the library" is extra info — it needs commas on both sides. "That" clauses (defining) do not use commas.',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'sentence_5',
          ...
          correctIndex: 0,
          hint:
              'A compound-complex sentence has at least one subordinate clause AND two main clauses joined by a conjunction.',
          explanation:
              'Subordinate clause: "Because she studied hard," + main clause 1: "she passed the test" + coordinating conjunction "and" + main clause 2: "her parents were proud".',
          difficulty: 5,
        ),
        LiteracyQuestion(
          id: 'sentence_6',
          skillId: 'sentence_formation',
          question:
              'Identify the error: "Running through the park, the flowers looked beautiful."',
          options: [
          ...
          correctIndex: 1,
          hint:
              'Who or what is doing the running? The subject after the comma must be the runner.',
          explanation:
              'The participial phrase "Running through the park" must describe the subject — but "the flowers" cannot run. This is a dangling modifier. Fix: "Running through the park, she noticed the flowers looked beautiful."',
          difficulty: 5,
        ),
      ];
}
