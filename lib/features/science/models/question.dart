...
class BiologicalSciencesQuestions {
  static const List<ScienceQuestion> questions = [
    ...
    ScienceQuestion(
      ...
      explanation:
          'A flower is a living plant! It grows, needs water, and can reproduce.',
    ),
    ScienceQuestion(
      id: 'bio_2',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'Plants need water from soil, sunlight from the sun, and nutrients from soil to grow strong!',
    ),
    ScienceQuestion(
      id: 'bio_3',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'Animals eat food for energy and to grow. Different animals eat different things!',
    ),
    ScienceQuestion(
      id: 'bio_4',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'Birds have feathers! Feathers help them fly and keep them warm.',
    ),
    ScienceQuestion(
      id: 'bio_5',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'Fish live in water - in oceans, rivers, and lakes. Water is their habitat!',
    ),
    // Level 2 - Life Cycles
    ScienceQuestion(
      id: 'bio_6',
      ...
      explanation:
          'A caterpillar becomes a butterfly! This change is called metamorphosis.',
    ),
    ScienceQuestion(
      id: 'bio_7',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'A frog starts as a tadpole! Tadpoles live in water have tails, then transform into frogs.',
    ),
    ScienceQuestion(
      id: 'bio_8',
      skillId: 'skill_biological_sciences',
    ...
    ScienceQuestion(
      ...
      explanation:
          'Roots absorb water and minerals from the soil to help the plant grow and stay strong!',
    ),
    ...
    ScienceQuestion(
      ...
      explanation:
          'The circulatory system pumps blood through your body, delivering oxygen and nutrients!',
    ),
    ScienceQuestion(
      id: 'bio_11',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'We breathe in oxygen from the air. Our body uses it for energy and survival!',
    ),
    ScienceQuestion(
      id: 'bio_12',
      skillId: 'skill_biological_sciences',
      ...
      explanation:
          'Herbivores eat only plants. Cows eat grass and rabbits eat vegetables and plants!',
    ),
  ];
...
class EarthSciencesQuestions {
  static const List<ScienceQuestion> questions = [
    ...
    ScienceQuestion(
      ...
      hint: 'It\'s wet...',
      explanation:
          'Water droplets fall from clouds as rain. This is part of the water cycle!',
    ),
    ScienceQuestion(
      id: 'earth_2',
      skillId: 'skill_earth_sciences',
      ...
      options: [
        'Only sand',
        'Rock pieces, minerals, and dead plants',
        'Only dirt',
        'Only clay'
      ],
      correctIndex: 1,
      ...
      explanation:
          'Soil is made of broken rocks, minerals, and dead plant matter. Plants grow in soil!',
    ),
    ScienceQuestion(
      id: 'earth_3',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'The four seasons are spring, summer, fall (autumn), and winter. They repeat each year!',
    ),
    ScienceQuestion(
      id: 'earth_4',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'The sun heats the Earth with its energy! Without the sun, there would be no life.',
    ),
    ScienceQuestion(
      id: 'earth_5',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'Water covers about 70% of Earth\'s surface! Most is in oceans and seas.',
    ),
    ...
    ScienceQuestion(
      ...
      explanation:
          'Rocks are made of minerals! Different combinations of minerals make different rocks.',
    ),
    ScienceQuestion(
      id: 'earth_7',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'Earthquakes are caused by movement of massive rock plates under Earth\'s crust!',
    ),
    ScienceQuestion(
      id: 'earth_8',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'The water cycle: water evaporates, forms clouds, then falls as rain or snow!',
    ),
    ScienceQuestion(
      id: 'earth_9',
      skillId: 'skill_earth_sciences',
      ...
      options: [
        'It becomes ice',
        'It turns into water vapor and rises into the air',
        'It disappears',
        'It becomes salt'
      ],
      correctIndex: 1,
      ...
      explanation:
          'Evaporation is when water turns into vapor and floats up into the atmosphere!',
    ),
    ...
    ScienceQuestion(
      ...
      explanation:
          'The atmosphere is the layer of gases (air) that surrounds Earth. We live in it!',
    ),
    ScienceQuestion(
      id: 'earth_11',
      skillId: 'skill_earth_sciences',
      ...
      options: [
        'Living animals',
        'Plants today',
        'Remains of ancient life preserved in rocks',
        'Modern stones'
      ],
      correctIndex: 2,
      difficulty: 3,
      ...
      explanation:
          'Fossils are the preserved remains of living things from long ago, found in rocks!',
    ),
    ScienceQuestion(
      id: 'earth_12',
      skillId: 'skill_earth_sciences',
      ...
      explanation:
          'Weathering is when rocks are broken into smaller pieces by wind, water, ice, and temperature changes!',
    ),
  ];
...
class PhysicalSciencesQuestions {
  static const List<ScienceQuestion> questions = [
    ...
    ScienceQuestion(
      ...
      explanation:
          'Gravity is a force that pulls things toward Earth. That\'s why things fall down!',
    ),
    ScienceQuestion(
      id: 'phys_2',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'Motion is when something changes position and moves from one place to another!',
    ),
    ScienceQuestion(
      id: 'phys_3',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'A magnet is an object that attracts metals like iron. Magnets have two poles!',
    ),
    ScienceQuestion(
      id: 'phys_4',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'Light sources include the sun, light bulbs, candles, and fires. They produce light energy!',
    ),
    ScienceQuestion(
      id: 'phys_5',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'The three states of matter are solid (like ice), liquid (like water), and gas (like steam)!',
    ),
    // Level 2 - Energy & Heat
    ScienceQuestion(
      id: 'phys_6',
      ...
      explanation:
          'Heat is thermal energy that makes things warm. Heat flows from hot to cold places!',
    ),
    ScienceQuestion(
      id: 'phys_7',
      skillId: 'skill_physical_sciences',
    ...
    ScienceQuestion(
      ...
      explanation:
          'Sound travels in waves through air and other materials. It needs a medium to travel!',
    ),
    ScienceQuestion(
      id: 'phys_9',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'Electricity is energy from moving electrons. It powers our homes and devices!',
    ),
    ...
    ScienceQuestion(
      ...
      explanation:
          'Melting is when a solid changes to a liquid by adding heat. Ice melts into water!',
    ),
    ScienceQuestion(
      id: 'phys_11',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'Momentum is the tendency of a moving object to continue moving in the same direction!',
    ),
    ScienceQuestion(
      id: 'phys_12',
      skillId: 'skill_physical_sciences',
      ...
      explanation:
          'Friction is a force that resists motion when surfaces rub together. It slows things down!',
    ),
  ];
