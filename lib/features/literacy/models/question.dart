...
class ComprehensionQuestions {
  static const List<LiteracyQuestion> questions = [
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_comprehension',
      question:
          'Read: "Mia went to the park with her dog." Who went to the park?',
      options: [
        'Mia\'s cat',
        'Mia and her dog',
        'The dog alone',
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_comprehension',
      question:
          'Read: "It was raining hard, so Tom stayed inside." Why did Tom stay inside?',
      options: [
        'He was tired',
        'It was raining',
        'He was sick',
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_comprehension',
      question:
          'Read: "Anna put on her coat, hat, and gloves. She grabbed her scarf." What season is it likely?',
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_comprehension',
      question:
          'Read: "The boy ran to the store. His mother was waiting." What can we infer?',
      options: [
        'The boy was late',
      ...
      explanation:
          'If mother was waiting, they likely planned to meet at the store',
      difficulty: 3,
    ),
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_comprehension',
      question:
          'Read: "Sofia loved reading. Every day after school she went to the library." What can we predict?',
      options: [
        'Sofia will become a teacher',
        'Sofia will continue reading often',
        'Sofia will not like books',
        'Sofia will move away'
      ],
      correctIndex: 1,
      hint: 'What does her behavior tell us?',
      explanation:
          'Her love of reading and daily library visits suggest she will continue this habit',
      difficulty: 4,
    ),
    LiteracyQuestion(
      id: 'comp_7',
      skillId: 'skill_comprehension',
      question:
          'Read: "The main character overcame many challenges to achieve her dream." What is the theme?',
      options: [
      ...
      explanation:
          'Overcoming challenges shows themes of persistence and determination',
      difficulty: 4,
    ),
  ];
...
class HigherOrderThinkingLiteracyQuestions {
  static const List<LiteracyQuestion> questions = [
    ...
    LiteracyQuestion(
      ...
      options: [
        'The girl, she went to the store quickly.',
        'The girl went quickly to the store.',
        'The girl to the store went quickly.',
        'The store the girl went to quickly.'
      ],
      correctIndex: 1,
      hint: 'Look for natural word order',
      explanation:
          '"The girl went quickly to the store" flows naturally and is grammatically correct',
      difficulty: 4,
    ),
    LiteracyQuestion(
      id: 'hot_lit_2',
      skillId: 'skill_critical_thinking',
      question:
          'Read both versions. Which ending is more satisfying and why? A) "She left. The end." B) "She learned her lesson and smiled, ready for tomorrow."',
      options: [
        'A is better - it\'s short',
        'B is better - it gives closure and hope',
      ...
      explanation:
          'B provides emotional resolution and suggests character growth, making it more satisfying',
      difficulty: 5,
    ),
    LiteracyQuestion(
      id: 'hot_lit_3',
      skillId: 'skill_critical_thinking',
      question:
          'Compare: "It was a sunny day." vs "Golden sunlight streamed through the clouds." Which creates a better image?',
      options: [
        'First - it\'s simpler',
        'Second - it uses descriptive language',
        'Both are the same',
        'Neither works well'
      ],
      correctIndex: 1,
      ...
      explanation:
          'The second uses vivid descriptive language that creates a stronger mental image',
      difficulty: 5,
    ),
    ...
    LiteracyQuestion(
      ...
      skillId: 'skill_critical_thinking',
      question:
          'Create an ending for: "She found a mysterious key in the old chest." Which ending fits best?',
      options: [
        'She threw it away.',
        'She used it to unlock a hidden room full of treasures.',
      ...
      explanation:
          'Creating mystery and adventure with a discovery fits the mysterious key setup',
      difficulty: 6,
    ),
    LiteracyQuestion(
      id: 'hot_lit_5',
      skillId: 'skill_critical_thinking',
      question:
          'Rewrite this plain sentence with better descriptive language: "The dog was happy." What would be best?',
      options: [
        'The dog was really happy.',
        'The dog wagged its tail joyfully, its tongue out in a wide grin.',
        'The dog was very happy.',
        'The happy dog was happy.'
      ],
      correctIndex: 1,
      hint: 'Add specific, vivid details',
      explanation:
          'The second version shows happiness through specific actions and imagery instead of just stating it',
      difficulty: 6,
    ),
    LiteracyQuestion(
      id: 'hot_lit_6',
      skillId: 'skill_critical_thinking',
      question:
          'Create a character description that shows personality. Which is most effective?',
      options: [
        'The girl was nice.',
        'Emma always shared her lunch and listened to everyone\'s problems, even those nobody liked.',
        'The girl was very nice.',
        'A nice girl named Emma.'
      ],
      correctIndex: 1,
      hint: 'Show through actions, not just tell',
      explanation:
          'Showing through specific behaviors and actions reveals character much more effectively',
      difficulty: 6,
    ),
  ];
